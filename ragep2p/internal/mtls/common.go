...
func VerifyCertMatchesPubKey(logger commontypes.Logger, publicKey [32]byte) func(rawCerts [][]byte, verifiedChains [][]*x509.Certificate) error {
	return func(rawCerts [][]byte, verifiedChains [][]*x509.Certificate) error {
		...
		logger.Trace("Got good cert", commontypes.LogFields{"publicKey": hex.EncodeToString(publicKey[:])})
		return nil
	}
}
