...
func (x *MessageWrapper) GetMessageBlockSync() *MessageBlockSync {
	if x, ok := x.GetMsg().(*MessageWrapper_MessageBlockSync); ok {
		return x.MessageBlockSync
	}
	return nil
}

func (x *MessageWrapper) GetMessageBlockSyncSummary() *MessageBlockSyncSummary {
	if x, ok := x.GetMsg().(*MessageWrapper_MessageBlockSyncSummary); ok {
		return x.MessageBlockSyncSummary
	}
	return nil
}
...
func (x *MessageWrapper) GetMessageBlobAvailable() *MessageBlobAvailable {
	if x, ok := x.GetMsg().(*MessageWrapper_MessageBlobAvailable); ok {
		return x.MessageBlobAvailable
	}
	return nil
}
...
type MessageWrapper_MessageBlockSync struct {
	MessageBlockSync *MessageBlockSync `protobuf:"bytes,29,opt,name=message_block_sync,json=messageBlockSync,proto3,oneof"`
}

type MessageWrapper_MessageBlockSyncSummary struct {
	MessageBlockSyncSummary *MessageBlockSyncSummary `protobuf:"bytes,30,opt,name=message_block_sync_summary,json=messageBlockSyncSummary,proto3,oneof"`
}

type MessageWrapper_MessageBlobOffer struct {
	MessageBlobOffer *MessageBlobOffer `protobuf:"bytes,31,opt,name=message_blob_offer,json=messageBlobOffer,proto3,oneof"`
}

type MessageWrapper_MessageBlobChunkRequest struct {
	MessageBlobChunkRequest *MessageBlobChunkRequest `protobuf:"bytes,32,opt,name=message_blob_chunk_request,json=messageBlobChunkRequest,proto3,oneof"`
}

type MessageWrapper_MessageBlobChunkResponse struct {
	MessageBlobChunkResponse *MessageBlobChunkResponse `protobuf:"bytes,33,opt,name=message_blob_chunk_response,json=messageBlobChunkResponse,proto3,oneof"`
}

type MessageWrapper_MessageBlobAvailable struct {
	MessageBlobAvailable *MessageBlobAvailable `protobuf:"bytes,34,opt,name=message_blob_available,json=messageBlobAvailable,proto3,oneof"`
}
...
func (*MessageWrapper_MessageBlockSync) isMessageWrapper_Msg() {}

func (*MessageWrapper_MessageBlockSyncSummary) isMessageWrapper_Msg() {}
...
func (*MessageWrapper_MessageBlobAvailable) isMessageWrapper_Msg() {}
...
type MessageBlockSyncRequest struct {
	...
	HighestCommittedSeqNr uint64 `protobuf:"varint,1,opt,name=highest_committed_seq_nr,json=highestCommittedSeqNr,proto3" json:"highest_committed_seq_nr,omitempty"`
...
func (x *MessageBlockSyncRequest) GetHighestCommittedSeqNr() uint64 {
	if x != nil {
...
type MessageBlockSync struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AttestedStateTransitionBlocks []*AttestedStateTransitionBlock `protobuf:"bytes,1,rep,name=attested_state_transition_blocks,json=attestedStateTransitionBlocks,proto3" json:"attested_state_transition_blocks,omitempty"`
	Nonce                         uint64                          `protobuf:"varint,2,opt,name=nonce,proto3" json:"nonce,omitempty"`
}

func (x *MessageBlockSync) Reset() {
	*x = MessageBlockSync{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageBlockSync) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageBlockSync) ProtoMessage() {}

func (x *MessageBlockSync) ProtoReflect() protoreflect.Message {
	mi := &file_offchainreporting3_1_messages_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageBlockSync.ProtoReflect.Descriptor instead.
func (*MessageBlockSync) Descriptor() ([]byte, []int) {
	return file_offchainreporting3_1_messages_proto_rawDescGZIP(), []int{13}
}

func (x *MessageBlockSync) GetAttestedStateTransitionBlocks() []*AttestedStateTransitionBlock {
	if x != nil {
...
func (x *MessageBlockSync) GetNonce() uint64 {
	if x != nil {
		return x.Nonce
	}
	return 0
...
type MessageBlockSyncSummary struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MessageBlockSyncSummary) Reset() {
	*x = MessageBlockSyncSummary{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageBlockSyncSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageBlockSyncSummary) ProtoMessage() {}

func (x *MessageBlockSyncSummary) ProtoReflect() protoreflect.Message {
	mi := &file_offchainreporting3_1_messages_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageBlockSyncSummary.ProtoReflect.Descriptor instead.
func (*MessageBlockSyncSummary) Descriptor() ([]byte, []int) {
	return file_offchainreporting3_1_messages_proto_rawDescGZIP(), []int{14}
}

func (x *MessageBlockSyncSummary) GetLowestPersistedSeqNr() uint64 {
	if x != nil {
...
type CertifiedPrepare struct {
	...
	ReportsPlusPrecursor        []byte                        `protobuf:"bytes,5,opt,name=reports_plus_precursor,json=reportsPlusPrecursor,proto3" json:"reports_plus_precursor,omitempty"`
	PrepareQuorumCertificate    []*AttributedPrepareSignature `protobuf:"bytes,6,rep,name=prepare_quorum_certificate,json=prepareQuorumCertificate,proto3" json:"prepare_quorum_certificate,omitempty"`
}
...
type CertifiedCommit struct {
	...
	StateTransitionOutputs      *StateTransitionOutputs      `protobuf:"bytes,4,opt,name=state_transition_outputs,json=stateTransitionOutputs,proto3" json:"state_transition_outputs,omitempty"`
	ReportsPlusPrecursor        []byte                       `protobuf:"bytes,5,opt,name=reports_plus_precursor,json=reportsPlusPrecursor,proto3" json:"reports_plus_precursor,omitempty"`
	CommitQuorumCertificate     []*AttributedCommitSignature `protobuf:"bytes,6,rep,name=commit_quorum_certificate,json=commitQuorumCertificate,proto3" json:"commit_quorum_certificate,omitempty"`
}
...
func (x *MessageBlobOffer) GetSubmitter() uint32 {
	if x != nil {
		return x.Submitter
	}
	return 0
...
type MessageBlobAvailable struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MessageBlobAvailable) Reset() {
	*x = MessageBlobAvailable{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageBlobAvailable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageBlobAvailable) ProtoMessage() {}

func (x *MessageBlobAvailable) ProtoReflect() protoreflect.Message {
	mi := &file_offchainreporting3_1_messages_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageBlobAvailable.ProtoReflect.Descriptor instead.
func (*MessageBlobAvailable) Descriptor() ([]byte, []int) {
	return file_offchainreporting3_1_messages_proto_rawDescGZIP(), []int{36}
}

func (x *MessageBlobAvailable) GetBlobDigest() []byte {
	if x != nil {
		return x.BlobDigest
	}
	return nil
...
func (x *MessageBlobAvailable) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_offchainreporting3_1_messages_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x33, 0x5f, 0x31, 0x22, 0xa2, 0x0e, 0x0a, 0x0e,
	...
	,
	...
	,
	...
	0x0c, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x99, 0x01, 0x0a, 0x12, 0x4d, 0x65, 0x73,
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x73, 0x65, 0x71, 0x4e, 0x72, 0x12, 0x56, 0x0a, 0x12,
	0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x5f, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6f, 0x66, 0x66, 0x63, 0x68,
	0x61, 0x69, 0x6e, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x33, 0x5f, 0x31, 0x2e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xb7, 0x01, 0x0a, 0x0f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63,
	...
	0x73, 0x65, 0x71, 0x4e, 0x72, 0x12, 0x77, 0x0a, 0x1e, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75,
	0x74, 0x65, 0x64, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x5f, 0x6f, 0x62, 0x73, 0x65, 0x72,
	0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e,
	0x6f, 0x66, 0x66, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e,
	0x67, 0x33, 0x5f, 0x31, 0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x64, 0x53,
	...
	0x65, 0x64, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x5b,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x73, 0x65, 0x71, 0x4e, 0x72, 0x12, 0x1c, 0x0a,
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x5a, 0x0a, 0x0d, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x14, 0x0a, 0x05,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x63, 0x61, 0x74, 0x65, 0x22, 0x82, 0x03, 0x0a, 0x19, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x64, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x65, 0x70,
	0x6f, 0x63, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x69,
	0x74, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x71, 0x5f, 0x6e, 0x72,
	...
	,
	...
	,
	...
	0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x22, 0xb0, 0x01, 0x0a, 0x1f, 0x53, 0x69, 0x67,
	0x6e, 0x65, 0x64, 0x48, 0x69, 0x67, 0x68, 0x65, 0x73, 0x74, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x6f, 0x0a, 0x1b,
	...
	0x0b, 0x32, 0x2f, 0x2e, 0x6f, 0x66, 0x66, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x72, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x69, 0x6e, 0x67, 0x33, 0x5f, 0x31, 0x2e, 0x48, 0x69, 0x67, 0x68, 0x65, 0x73, 0x74,
	0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x52, 0x19, 0x68, 0x69, 0x67, 0x68, 0x65, 0x73, 0x74, 0x43, 0x65, 0x72, 0x74, 0x69,
	0x66, 0x69, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x1c, 0x0a,
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x55, 0x0a, 0x15, 0x41,
	...
	0x65, 0x72, 0x22, 0x91, 0x01, 0x0a, 0x1b, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	0x64, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x56, 0x0a, 0x12, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x5f, 0x6f, 0x62, 0x73,
	0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27,
	0x2e, 0x6f, 0x66, 0x66, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x69,
	0x6e, 0x67, 0x33, 0x5f, 0x31, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x4f, 0x62, 0x73, 0x65,
	...
	0x65, 0x72, 0x22, 0xe6, 0x01, 0x0a, 0x1c, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x65, 0x64, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x12, 0x60, 0x0a, 0x16, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x72, 0x61,
	0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x6f, 0x66, 0x66, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x72, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x33, 0x5f, 0x31, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	,
	...
	,
	...
	0x64, 0x22, 0xd6, 0x01, 0x0a, 0x15, 0x53, 0x74, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x12, 0x15, 0x0a, 0x06, 0x73,
	0x65, 0x71, 0x5f, 0x6e, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x73, 0x65, 0x71,
	0x4e, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x71,
	0x75, 0x65, 0x72, 0x79, 0x12, 0x64, 0x0a, 0x17, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
	0x65, 0x64, 0x5f, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x6f, 0x66, 0x66, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	0x6f, 0x6e, 0x52, 0x16, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x64, 0x4f, 0x62,
	0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xa0, 0x01, 0x0a, 0x10, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x6c, 0x6f, 0x62, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x12,
	...
	,
...
var file_offchainreporting3_1_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_offchainreporting3_1_messages_proto_goTypes = []interface{}{
	...
	(*MessageBlockSync)(nil),                          // 13: offchainreporting3_1.MessageBlockSync
	(*MessageBlockSyncSummary)(nil),                   // 14: offchainreporting3_1.MessageBlockSyncSummary
	(*EpochStartProof)(nil),                           // 15: offchainreporting3_1.EpochStartProof
	(*CertifiedPrepareOrCommit)(nil),                  // 16: offchainreporting3_1.CertifiedPrepareOrCommit
	(*CertifiedPrepare)(nil),                          // 17: offchainreporting3_1.CertifiedPrepare
	(*CertifiedCommit)(nil),                           // 18: offchainreporting3_1.CertifiedCommit
	(*CertifiedCommittedReports)(nil),                 // 19: offchainreporting3_1.CertifiedCommittedReports
	(*HighestCertifiedTimestamp)(nil),                 // 20: offchainreporting3_1.HighestCertifiedTimestamp
	(*AttributedSignedHighestCertifiedTimestamp)(nil), // 21: offchainreporting3_1.AttributedSignedHighestCertifiedTimestamp
	(*SignedHighestCertifiedTimestamp)(nil),           // 22: offchainreporting3_1.SignedHighestCertifiedTimestamp
	(*AttributedObservation)(nil),                     // 23: offchainreporting3_1.AttributedObservation
	(*AttributedSignedObservation)(nil),               // 24: offchainreporting3_1.AttributedSignedObservation
	(*SignedObservation)(nil),                         // 25: offchainreporting3_1.SignedObservation
	(*AttributedPrepareSignature)(nil),                // 26: offchainreporting3_1.AttributedPrepareSignature
	(*AttributedCommitSignature)(nil),                 // 27: offchainreporting3_1.AttributedCommitSignature
	(*AttestedStateTransitionBlock)(nil),              // 28: offchainreporting3_1.AttestedStateTransitionBlock
	(*StateTransitionBlock)(nil),                      // 29: offchainreporting3_1.StateTransitionBlock
	(*StateTransitionOutputs)(nil),                    // 30: offchainreporting3_1.StateTransitionOutputs
	(*KeyValueModification)(nil),                      // 31: offchainreporting3_1.KeyValueModification
	(*StateTransitionInputs)(nil),                     // 32: offchainreporting3_1.StateTransitionInputs
	(*MessageBlobOffer)(nil),                          // 33: offchainreporting3_1.MessageBlobOffer
	(*MessageBlobChunkRequest)(nil),                   // 34: offchainreporting3_1.MessageBlobChunkRequest
	(*MessageBlobChunkResponse)(nil),                  // 35: offchainreporting3_1.MessageBlobChunkResponse
	(*MessageBlobAvailable)(nil),                      // 36: offchainreporting3_1.MessageBlobAvailable
	(*AttributedBlobAvailabilitySignature)(nil),       // 37: offchainreporting3_1.AttributedBlobAvailabilitySignature
}
var file_offchainreporting3_1_messages_proto_depIdxs = []int32{
	...
	13, // 12: offchainreporting3_1.MessageWrapper.message_block_sync:type_name -> offchainreporting3_1.MessageBlockSync
	14, // 13: offchainreporting3_1.MessageWrapper.message_block_sync_summary:type_name -> offchainreporting3_1.MessageBlockSyncSummary
	33, // 14: offchainreporting3_1.MessageWrapper.message_blob_offer:type_name -> offchainreporting3_1.MessageBlobOffer
	34, // 15: offchainreporting3_1.MessageWrapper.message_blob_chunk_request:type_name -> offchainreporting3_1.MessageBlobChunkRequest
	35, // 16: offchainreporting3_1.MessageWrapper.message_blob_chunk_response:type_name -> offchainreporting3_1.MessageBlobChunkResponse
	36, // 17: offchainreporting3_1.MessageWrapper.message_blob_available:type_name -> offchainreporting3_1.MessageBlobAvailable
	16, // 18: offchainreporting3_1.MessageEpochStartRequest.highest_certified:type_name -> offchainreporting3_1.CertifiedPrepareOrCommit
	22, // 19: offchainreporting3_1.MessageEpochStartRequest.signed_highest_certified_timestamp:type_name -> offchainreporting3_1.SignedHighestCertifiedTimestamp
	15, // 20: offchainreporting3_1.MessageEpochStart.epoch_start_proof:type_name -> offchainreporting3_1.EpochStartProof
	25, // 21: offchainreporting3_1.MessageObservation.signed_observation:type_name -> offchainreporting3_1.SignedObservation
	24, // 22: offchainreporting3_1.MessageProposal.attributed_signed_observations:type_name -> offchainreporting3_1.AttributedSignedObservation
	19, // 23: offchainreporting3_1.MessageCertifiedCommit.certified_committed_reports:type_name -> offchainreporting3_1.CertifiedCommittedReports
	28, // 24: offchainreporting3_1.MessageBlockSync.attested_state_transition_blocks:type_name -> offchainreporting3_1.AttestedStateTransitionBlock
	16, // 25: offchainreporting3_1.EpochStartProof.highest_certified:type_name -> offchainreporting3_1.CertifiedPrepareOrCommit
	21, // 26: offchainreporting3_1.EpochStartProof.highest_certified_proof:type_name -> offchainreporting3_1.AttributedSignedHighestCertifiedTimestamp
	17, // 27: offchainreporting3_1.CertifiedPrepareOrCommit.prepare:type_name -> offchainreporting3_1.CertifiedPrepare
	18, // 28: offchainreporting3_1.CertifiedPrepareOrCommit.commit:type_name -> offchainreporting3_1.CertifiedCommit
	30, // 29: offchainreporting3_1.CertifiedPrepare.state_transition_outputs:type_name -> offchainreporting3_1.StateTransitionOutputs
	26, // 30: offchainreporting3_1.CertifiedPrepare.prepare_quorum_certificate:type_name -> offchainreporting3_1.AttributedPrepareSignature
	30, // 31: offchainreporting3_1.CertifiedCommit.state_transition_outputs:type_name -> offchainreporting3_1.StateTransitionOutputs
	27, // 32: offchainreporting3_1.CertifiedCommit.commit_quorum_certificate:type_name -> offchainreporting3_1.AttributedCommitSignature
	27, // 33: offchainreporting3_1.CertifiedCommittedReports.commit_quorum_certificate:type_name -> offchainreporting3_1.AttributedCommitSignature
	22, // 34: offchainreporting3_1.AttributedSignedHighestCertifiedTimestamp.signed_highest_certified_timestamp:type_name -> offchainreporting3_1.SignedHighestCertifiedTimestamp
	20, // 35: offchainreporting3_1.SignedHighestCertifiedTimestamp.highest_certified_timestamp:type_name -> offchainreporting3_1.HighestCertifiedTimestamp
	25, // 36: offchainreporting3_1.AttributedSignedObservation.signed_observation:type_name -> offchainreporting3_1.SignedObservation
	29, // 37: offchainreporting3_1.AttestedStateTransitionBlock.state_transition_block:type_name -> offchainreporting3_1.StateTransitionBlock
	27, // 38: offchainreporting3_1.AttestedStateTransitionBlock.attributed_signatures:type_name -> offchainreporting3_1.AttributedCommitSignature
	30, // 39: offchainreporting3_1.StateTransitionBlock.state_transition_outputs:type_name -> offchainreporting3_1.StateTransitionOutputs
	31, // 40: offchainreporting3_1.StateTransitionOutputs.write_set:type_name -> offchainreporting3_1.KeyValueModification
	23, // 41: offchainreporting3_1.StateTransitionInputs.attributed_observations:type_name -> offchainreporting3_1.AttributedObservation
...
func file_offchainreporting3_1_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_offchainreporting3_1_messages_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageBlockSyncSummary); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_offchainreporting3_1_messages_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageBlobAvailable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_offchainreporting3_1_messages_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*MessageWrapper_MessageBlockSync)(nil),
		(*MessageWrapper_MessageBlockSyncSummary)(nil),
		(*MessageWrapper_MessageBlobOffer)(nil),
		(*MessageWrapper_MessageBlobChunkRequest)(nil),
		(*MessageWrapper_MessageBlobChunkResponse)(nil),
		(*MessageWrapper_MessageBlobAvailable)(nil),
	}
	file_offchainreporting3_1_messages_proto_msgTypes[16].OneofWrappers = []interface{}{
