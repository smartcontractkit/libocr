...
type StatePersistenceState struct {
	...
	HighestPersistedStateTransitionBlockSeqNr uint64 `protobuf:"varint,1,opt,name=highest_persisted_state_transition_block_seq_nr,json=highestPersistedStateTransitionBlockSeqNr,proto3" json:"highest_persisted_state_transition_block_seq_nr,omitempty"`
}

func (x *StatePersistenceState) Reset() {
	*x = StatePersistenceState{}
	if protoimpl.UnsafeEnabled {
...
func (x *StatePersistenceState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StatePersistenceState) ProtoMessage() {}

func (x *StatePersistenceState) ProtoReflect() protoreflect.Message {
	mi := &file_offchainreporting3_1_db_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StatePersistenceState.ProtoReflect.Descriptor instead.
func (*StatePersistenceState) Descriptor() ([]byte, []int) {
	return file_offchainreporting3_1_db_proto_rawDescGZIP(), []int{1}
}

func (x *StatePersistenceState) GetHighestPersistedStateTransitionBlockSeqNr() uint64 {
	if x != nil {
		return x.HighestPersistedStateTransitionBlockSeqNr
	}
	return 0
}
...
var file_offchainreporting3_1_db_proto_rawDesc = []byte{
	...
	,
...
var file_offchainreporting3_1_db_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_offchainreporting3_1_db_proto_goTypes = []interface{}{
	(*PacemakerState)(nil),        // 0: offchainreporting3_1.PacemakerState
	(*StatePersistenceState)(nil), // 1: offchainreporting3_1.StatePersistenceState
}
...
func file_offchainreporting3_1_db_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_offchainreporting3_1_db_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StatePersistenceState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
