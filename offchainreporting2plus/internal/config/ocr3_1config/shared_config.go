...
func SharedConfigFromContractConfig[RI any](
	...
	publicConfig, encSharedSecret, err := publicConfigFromContractConfig(skipInsaneForProductionChecks, change)
	if err != nil {
...
func ContractSetConfigArgsFromSharedConfigDeterministic(
	...
	offchainConfig_ = (offchainConfig{
		...
		c.DeltaRound,
		c.DeltaGrace,
		c.DeltaReportsPlusPrecursorRequest,
		c.DeltaStage,

		// state sync
		c.DeltaStateSyncSummaryInterval,

		// block sync
		c.DeltaBlockSyncMinRequestToSameOracleInterval,
		c.DeltaBlockSyncResponseTimeout,
		c.MaxBlocksPerBlockSyncResponse,
		c.MaxParallelRequestedBlocks,

		// tree sync
		c.DeltaTreeSyncMinRequestToSameOracleInterval,
		c.DeltaTreeSyncResponseTimeout,
		c.MaxTreeSyncChunkKeys,
		c.MaxTreeSyncChunkKeysPlusValuesBytes,
		c.MaxParallelTreeSyncChunkFetches,

		// snapshotting
		c.SnapshotInterval,
		c.MaxHistoricalSnapshotsRetained,

		// blobs
		c.DeltaBlobOfferMinRequestToSameOracleInterval,
		c.DeltaBlobOfferResponseTimeout,
		c.DeltaBlobBroadcastGrace,
		c.DeltaBlobChunkMinRequestToSameOracleInterval,
		c.DeltaBlobChunkResponseTimeout,
		c.BlobChunkBytes,
		...
		c.WarnDurationQuery,
		c.WarnDurationObservation,
		c.WarnDurationValidateObservation,
		c.WarnDurationObservationQuorum,
		c.WarnDurationStateTransition,
