...
//
// Solidity: function setConfig(uint32 configVersion, uint8 n, uint8 f, bytes ocr3SignerPublicKeys) returns()
func (_DemoDynamicallyDispatchedAttestationVerifier *DemoDynamicallyDispatchedAttestationVerifierTransactor) SetConfig(opts *bind.TransactOpts, configVersion uint32, n uint8, f uint8, ocr3SignerPublicKeys []byte) (*types.Transaction, error) {
	return _DemoDynamicallyDispatchedAttestationVerifier.contract.Transact(opts, "setConfig", configVersion, n, f, ocr3SignerPublicKeys)
}

// SetConfig is a paid mutator transaction binding the contract method 0x6f289d41.
//
// Solidity: function setConfig(uint32 configVersion, uint8 n, uint8 f, bytes ocr3SignerPublicKeys) returns()
func (_DemoDynamicallyDispatchedAttestationVerifier *DemoDynamicallyDispatchedAttestationVerifierSession) SetConfig(configVersion uint32, n uint8, f uint8, ocr3SignerPublicKeys []byte) (*types.Transaction, error) {
	return _DemoDynamicallyDispatchedAttestationVerifier.Contract.SetConfig(&_DemoDynamicallyDispatchedAttestationVerifier.TransactOpts, configVersion, n, f, ocr3SignerPublicKeys)
}

// SetConfig is a paid mutator transaction binding the contract method 0x6f289d41.
//
// Solidity: function setConfig(uint32 configVersion, uint8 n, uint8 f, bytes ocr3SignerPublicKeys) returns()
func (_DemoDynamicallyDispatchedAttestationVerifier *DemoDynamicallyDispatchedAttestationVerifierTransactorSession) SetConfig(configVersion uint32, n uint8, f uint8, ocr3SignerPublicKeys []byte) (*types.Transaction, error) {
	return _DemoDynamicallyDispatchedAttestationVerifier.Contract.SetConfig(&_DemoDynamicallyDispatchedAttestationVerifier.TransactOpts, configVersion, n, f, ocr3SignerPublicKeys)
}
