...
import "../OCR3ECDSAAttestationVerifier.sol";

/// @title Demonstration contract showcasing the new ECDSA signature verification library for OCR
...
contract DemoECDSAAttestationVerifier is OCR3ECDSAAttestationVerifier {
